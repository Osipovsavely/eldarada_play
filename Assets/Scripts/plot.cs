...
{
    [SerializeField] GameObject event_object_1, event_object_2, event_object_3, event_object_4, event_object_5, event_object_6, portal, portal_3D, wall_panel;
    ...
    public void event_6()
    {
        event_object_6.SetActive(false);
        Playerdata.attak = 5;
